...
function NextIcon() {
  return (
    <svg viewBox="0 0 128 128" className="h-7 w-7">
      <path d="M64 0C28.7 0 0 28.7 0 64s28.7 64 64 64c11.2 0 21.7-2.9 30.8-7.9L48.4 55.3v36.6h-6.8V41.8h6.8l50.5 75.8C116.4 106.2 128 86.5 128 64c0-35.3-28.7-64-64-64zm22.1 84.6l-7.5-11.7V41.8h7.5v42.8z" fill="#ebebeb" />
    </svg>
  )
}
...
function GitHubIcon() {
  return (
    <svg viewBox="0 0 128 128" className="h-7 w-7">
      <path fillRule="evenodd" clipRule="evenodd" fill="#ebebeb" d="M64 5.103c-33.347 0-60.388 27.035-60.388 60.388 0 26.682 17.303 49.317 41.297 57.303 3.017.56 4.125-1.31 4.125-2.905 0-1.44-.056-6.197-.082-11.243-16.8 3.653-20.345-7.125-20.345-7.125-2.747-6.98-6.705-8.836-6.705-8.836-5.48-3.748.413-3.67.413-3.67 6.063.425 9.257 6.223 9.257 6.223 5.386 9.23 14.127 6.562 17.573 5.02.542-3.903 2.107-6.568 3.834-8.076-13.413-1.525-27.514-6.704-27.514-29.843 0-6.593 2.36-11.98 6.223-16.21-.628-1.52-2.695-7.662.584-15.98 0 0 5.07-1.623 16.61 6.19C53.7 35 58.867 34.327 64 34.304c5.13.023 10.3.694 15.127 2.033 11.526-7.813 16.59-6.19 16.59-6.19 3.287 8.317 1.22 14.46.593 15.98 3.872 4.23 6.215 9.617 6.215 16.21 0 23.194-14.127 28.3-27.574 29.796 2.167 1.874 4.097 5.55 4.097 11.183 0 8.08-.07 14.583-.07 16.572 0 1.607 1.088 3.49 4.148 2.897 23.98-7.994 41.263-30.622 41.263-57.294C124.388 32.14 97.35 5.104 64 5.104z" />
    </svg>
  )
}
...
function VercelIcon() {
  return (
    <svg viewBox="0 0 128 128" className="h-7 w-7">
      <path fill="#ebebeb" d="M64 0L128 110.848H0L64 0z" />
    </svg>
  )
}
...
function KeystaticIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none">
      <rect x="2" y="2" width="20" height="20" rx="4" fill="#1B1B1F" stroke="#ebebeb" strokeWidth="1" />
...
function PayloadIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none">
      <path d="M11 3L21 8.5V18L11 23.5V13.5L1 8.5L11 3Z" fill="#ebebeb" />
      <path d="M11 13.5L21 8.5" stroke="#0a0e14" strokeWidth="1.5" />
      <path d="M11 23.5V13.5" stroke="#0a0e14" strokeWidth="1.5" />
    </svg>
  )
}
                ...
                style={
                  hoveredIndex === i
                    ? {
                        ...
                        boxShadow: `0 0 32px 8px ${item.color}18, 0 4px 20px rgba(0,0,0,0.4)`,
            ...
            {filters.map((f) => (
              <button
                ...
                className={`rounded-lg border px-4 py-2 text-sm font-medium transition-all duration-300 ${
                  activeFilter === f.key
                    ? "border-primary/50 bg-primary/10 text-primary shadow-[0_0_16px_hsl(168_80%_58%/0.1)]"
